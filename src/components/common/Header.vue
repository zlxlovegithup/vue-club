<template>
	<div>
		...
		<div class="header-wrap">
			<el-menu :default-active="activeIndex" class="header computerNav" background-color="#22b3c8" mode="horizontal" text-color="#fff" active-text-color="#ffd04b">
        <el-menu-item index="1"><router-link :to="{ name: 'Home' }" tag="div">首页</router-link></el-menu-item>
				<el-submenu index="2">
					<template slot="title">
						社团概况
					</template>
					<el-menu-item index="2-1"><router-link :to="{ name: 'Passage', params: { id: 1 } }" tag="div">社团联合会简介</router-link></el-menu-item>
					<el-menu-item index="2-2"><router-link :to="{ name: 'Passage', params: { id: 2 } }" tag="div">社团简介</router-link></el-menu-item>
					<el-menu-item index="2-3"><router-link :to="{ name: 'Passage', params: { id: 108 } }" tag="div">机构设置</router-link></el-menu-item>
				</el-submenu>
				<el-submenu index="3">
					<template slot="title">
						社团快讯
				...
				<el-menu-item index="5"><router-link :to="{ name: 'ClubList', query: { typeId: 1 } }" tag="div">社团列表</router-link></el-menu-item>
          ...
          <!-- QQ交流模块 -->
            ...
            <!--2804774882-->
						<a target="_blank" href="http://wpa.qq.com/msgrd?v=3&uin=3371994757&site=qq&menu=yes">
							<img border="0" src="http://wpa.qq.com/pa?p=2:3371994757:51" alt="点击这里给我发消息" title="QQ交流" />
						</a>
					</el-menu-item>
          <!-- 给我写信模块 -->
...
export default {
  data () {
    return {
      activeIndex: '1',
      adminAccessUrl: 'http://127.0.0.1:8080' //'http://118.89.228.250:8012'
    }
  },
  methods: {
